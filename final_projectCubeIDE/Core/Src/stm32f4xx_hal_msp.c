...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PA15     ------> SPI1_NSS
    */
    GPIO_InitStruct.Pin = TFT_LCD_SCK_Pin|TFT_LCD_MISO_Pin|TFT_LCD_MOSI_Pin|TFT_LCD_NSS_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA15     ------> SPI1_NSS
    */
    HAL_GPIO_DeInit(GPIOA, TFT_LCD_SCK_Pin|TFT_LCD_MISO_Pin|TFT_LCD_MOSI_Pin|TFT_LCD_NSS_Pin);
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, MicroSD_SCK_Pin|MicroSD_NSS_Pin|MicroSD_MISO_Pin|MicroSD_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM11)
  {
    ...
    PF7     ------> TIM11_CH1
    */
    GPIO_InitStruct.Pin = MOTOR_L1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM11;
    HAL_GPIO_Init(MOTOR_L1_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM14)
  {
    ...
    PF9     ------> TIM14_CH1
    */
    GPIO_InitStruct.Pin = MOTOR_L2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM14;
    HAL_GPIO_Init(MOTOR_L2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART6)
  {
    ...
    PG14     ------> USART6_TX
    */
    HAL_GPIO_DeInit(GPIOG, BT_TX_Pin|BT_RX_Pin);
