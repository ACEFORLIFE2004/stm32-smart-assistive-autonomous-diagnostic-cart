...
#define MOTOR_R1_GPIO_Port GPIOF
#define MOTOR_R2_Pin GPIO_PIN_9
#define MOTOR_R2_GPIO_Port GPIOF
...
#define IR_RX_LEFT_Pin GPIO_PIN_13
#define IR_RX_LEFT_GPIO_Port GPIOF
#define BT_STATE_Pin GPIO_PIN_8
#define BT_STATE_GPIO_Port GPIOE
#define BT_STATE_EXTI_IRQn EXTI9_5_IRQn
#define IR_RX_CENTER_Pin GPIO_PIN_9
#define IR_RX_CENTER_GPIO_Port GPIOE
#define SENSOR_TRIG_L_Pin GPIO_PIN_10
#define SENSOR_TRIG_L_GPIO_Port GPIOE
#define IR_RX_RIGHT_Pin GPIO_PIN_11
#define IR_RX_RIGHT_GPIO_Port GPIOE
#define SENSOR_TRIG_C_Pin GPIO_PIN_12
#define SENSOR_TRIG_C_GPIO_Port GPIOE
#define SENSOR_TRIG_R_Pin GPIO_PIN_14
#define SENSOR_TRIG_R_GPIO_Port GPIOE
#define SENSOR_ECHO_R_Pin GPIO_PIN_15
#define SENSOR_ECHO_R_GPIO_Port GPIOE
#define SENSOR_ECHO_C_Pin GPIO_PIN_10
#define SENSOR_ECHO_C_GPIO_Port GPIOB
#define SENSOR_ECHO_L_Pin GPIO_PIN_11
#define SENSOR_ECHO_L_GPIO_Port GPIOB
